...
import com.sun.lje.activiti.util.AjaxResponse;
import com.sun.lje.activiti.util.GlobalConfig;
...
public class ProcessDefinitionController {
    ...
    public AjaxResponse uploadStreamAndDeployment(@RequestParam("processFile") MultipartFile multipartFile,String deploymentName) {
        // 获取上传的文件名
